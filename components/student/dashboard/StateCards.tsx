...
export function StateCards({
  ...
  return (
    <div className="w-full overflow-hidden px-2 md:px-0">
      <h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-orange-600 to-orange-400 bg-clip-text text-transparent border-b-2 border-orange-400 pb-2">
        Suggestions for you
      </h2>
      <div
        ref={containerRef}
      ...
      >
        <div
          ref={scrollRef}
          className="flex gap-3 md:gap-4 px-2 md:px-6"
        ...
        >
          {[...states, ...states].map((state, index) => (
            <div
              ...
              className={`
                flex-shrink-0 relative w-36 h-32 md:w-48 md:h-40 rounded-lg overflow-hidden cursor-pointer
            ...
            >
              ...
              <div className="relative h-full flex flex-col items-center justify-between p-3 md:p-4 z-10">
                ...
                <button
                  ...
                  className="px-2 py-1 md:px-3 md:py-1 bg-white/90 text-gray-800 rounded-full text-xs font-medium
            hover:bg-white transition-colors duration-200 mt-1 md:mt-2"
                >
                  View Details
                </button>
              </div>
